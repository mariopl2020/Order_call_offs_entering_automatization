"""Module with main functions of program """
...
class Program():
    ...
    def main_loop(self):
        ...
        self.order.back_to_original_colnames()
...
if __name__ == "__main__":
    ...
    try:
        program.main_run()
        program.main_loop()
        program.files_processing.write_dataframe_to_excel(program.order.orders_data_frame,\
                                                          "processed_orders.xlsx")
    except FileNotFoundError as any_file_error:
        print(any_file_error)
